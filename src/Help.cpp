...
Grid::Grid(int &n, int &m, double &xmin, double &xmax, double &ymin, double &ymax) : N(n), M(m), NI(n + 2), NJ(n + 2), xMin(xmin), xMax(xmax), yMin(ymin), yMax(ymax), Xlength(xMax - xMin), Ylength(yMax - yMin)
{
