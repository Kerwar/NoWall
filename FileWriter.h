...
public:
  ...
  void WriteInterParalel(string prefix, string sufix, int time, Grid &mainGrid, Grid &myGrid, Field::vectorField &Utemp, Field::vectorField &Vtemp, Field::vectorField &Ttemp, Field::vectorField &Ftemp, Field::vectorField &Ztemp, int iStr, int iEnd, int jStr, int jEnd, Paralel::Loc loc);
